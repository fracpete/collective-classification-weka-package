...
/**
 * Tests LLGC. Run from the command line with:<p/>
 * java weka.classifiers.collective.functions.LLGC
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 2019 $
 */
public class LLGCTest 
  extends AbstractCollectiveClassifierTest {

  public LLGCTest(String name) { 
    super(name);  
  }

  /** Creates a default LLGC */
  @Override
  ...
  public static Test suite() {
    return new TestSuite(LLGCTest.class);
  }
