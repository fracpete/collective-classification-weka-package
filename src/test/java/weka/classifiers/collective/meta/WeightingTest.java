...
/**
 * Tests Weighting. Run from the command line with:<p>
 * java weka.classifiers.collective.meta.WeightingTest
 *
...
public class WeightingTest 
  ...
  public WeightingTest(String name) { 
    super(name);  
  }
  ...
  public static Test suite() {
    return new TestSuite(WeightingTest.class);
  }
