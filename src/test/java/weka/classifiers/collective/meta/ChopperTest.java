...
/**
 * Tests Chopper. Run from the command line with:<p>
 * java weka.classifiers.collective.meta.ChopperTest
 *
...
public class ChopperTest 
  ...
  public ChopperTest(String name) { 
    super(name);  
  }

  /** Creates a default Chopper */
  @Override
  ...
  public static Test suite() {
    return new TestSuite(ChopperTest.class);
  }
